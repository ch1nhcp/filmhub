  ...
  movies.forEach((movie) => {
    ...
    <div class="movie-card">
              <img
                ...
                this.src='https://i.ebayimg.com/images/g/1EMAAMXQdGJR2-n3/s-l1600.jpg';"
                alt="Sorry, something went wrong"
              />
              <div
                class="movie-description p-2 d-flex justify-content-between align-items-center"
              >
                <h3 class="movie-title">${movieTitle}</h3>
                <h4 class="movie-vote">${movieVote}</h4>
              </div>
            </div>
    `;
